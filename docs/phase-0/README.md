...
|---|----------|-----------------|
| 00 | [Repository Audit](./00-repository-audit.md) | What exists in the canonical repository and what to preserve, harden, or remove. |
...
| 07 | [Migration Plan](./07-migration-plan.md) | The ordered, gated path from the current product and standalone prototype to a hardened engine and truthful demo, mapped to the directive's Phases 1–8. |
...
1. **Keep the Next.js/Cloudflare/Supabase project as the single source of truth.** Preserve its tested engine, schema, and product surfaces.
2. **Use one canonical repository and working path** so documentation, deployment, and implementation stay aligned.
